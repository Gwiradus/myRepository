...
import fleetEnv as fleet
import mip as mip


def export_output():
    return S, R_min, R_mean, R_max, min_e, max_e, t_time, price, arrival_time, departure_time, mip_opt, value


n_ev = 10
charger = 3.3  # kW
min_e, max_e, t_time, price, arrival_time, departure_time = fleet.initialise_fleet(n_ev)
